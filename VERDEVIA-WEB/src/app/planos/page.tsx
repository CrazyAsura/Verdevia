...
export const metadata = {
  ...
  description:
    'Licencas VERDEVIA para acesso aos paineis administrativos, operacao de prestadores e monitoramento executivo.',
};
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-[88vh] overflow-hidden pt-28">
        <Image
          ...
          alt="Painel administrativo VERDEVIA"
          fill
          priority
        ...
        <div className="relative mx-auto flex min-h-[calc(88vh-7rem)] max-w-7xl flex-col justify-center px-6 pb-16">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl font-black uppercase italic leading-none tracking-tight md:text-7xl">
              Planos para operar o <span className="text-primary text-glow">painel VERDEVIA</span>
            </h1>
            <p className="mt-6 max-w-2xl text-sm font-medium leading-7 text-muted-foreground md:text-base">
              Na web, a VERDEVIA vende licencas de uso premium para sustentar custos, investimento continuo,
