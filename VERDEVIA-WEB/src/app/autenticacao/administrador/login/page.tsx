              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-3">
                    ...
                    <FormControl>
                      <Input placeholder="admin@verdevia.app" {...field} className="h-16 bg-white/5 border-white/10 rounded-none focus:border-primary transition-all text-lg font-medium" />
                    </FormControl>
