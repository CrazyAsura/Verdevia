...
const initialMessages: ChatMessage[] = [
  {
    role: 'assistant',
    content:
      'Olá! Sou o assistente VERDEVIA. Posso ajudar com denúncias ambientais, reciclagem, documentos e dúvidas da plataforma.',
  },
];
...
export function ChatbotWidget() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await api.post<string>('/ai/chat', {
        message: question,
        context:
          'Chatbot flutuante do site VERDEVIA. Responda de forma curta, útil e em português do Brasil.',
      });
