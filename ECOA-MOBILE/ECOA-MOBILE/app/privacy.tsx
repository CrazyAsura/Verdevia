...
export default function PrivacyScreen() {
  ...
  const handleExportData = async () => {
    ...
    try {
      ...
      await Share.share({
        title: 'Meus Dados ECOA - Portabilidade',
        message: formatted,
      });
    } catch (error) {
            ...
            <Box className="p-4 rounded-2xl" style={{ backgroundColor: theme.card, borderColor: theme.border, borderWidth: 1 }}>
              <HStack className="items-start">
                ...
                <Text className="flex-1 text-sm leading-5" style={{ color: theme.textSecondary }}>
                  Para duvidas sobre o tratamento de dados, entre em contato com o encarregado de protecao de dados da ECOA pelos canais oficiais.
                </Text>
              </HStack>
            </Box>
          </VStack>
