...
export default function RegisterScreen() {
  ...
  const getHeaderInfo = () => {
    switch(step) {
      ...
      case 4: return { title: "Finalize seu acesso", subtitle: "Escolha suas credenciais para entrar no ECOA." };
    }
  };
        ...
        <View style={styles.modalOverlay}>
          <Animated.View entering={FadeInUp} style={styles.modalContent}>
            ...
            <Text style={styles.modalText}>
              Na ECOA, levamos sua privacidade a sério. Seus dados pessoais são coletados apenas para garantir sua identidade e segurança na plataforma, em conformidade com a LGPD.
            </Text>
