...
const OUTPUT_PATH = path.join(__dirname, '../../ECOA_Documentacao.docx');
  ...
  sections: [
    {
        ...
        default: new Header({
          children: [
            new Paragraph({
              ...
              children: [new TextRun({ text: "ECOA — Manual de Documentação Técnica", size: 18, color: COLOR_SECONDARY })]
            })
          ]
        })
      },
      ...
      children: [
        ...
        new Paragraph({ style: "Title", children: [new TextRun("ECOA")] }),
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "O ECOA é um ecossistema completo de fiscalização urbana e governança comunitária, projetado de forma modular sob a filosofia de acoplamento fraco e clean architecture (arquitetura hexagonal). Ele é dividido em três componentes centrais:"
            })
          ]
        }),
            ...
            new TableRow({
              children: [
                new TableCell({
                  borders: cellBorders,
                  width: { size: 2500, type: WidthType.DXA },
                  children: [new Paragraph({ children: [new TextRun({ text: "ECOA-MOBILE", bold: true })] })]
                }),
                new TableCell({
                  borders: cellBorders,
                  width: { size: 6860, type: WidthType.DXA },
            ...
            new TableRow({
              children: [
                new TableCell({
                  borders: cellBorders,
                  width: { size: 2500, type: WidthType.DXA },
                  children: [new Paragraph({ children: [new TextRun({ text: "ECOA-WEB", bold: true })] })]
                }),
                new TableCell({
                  borders: cellBorders,
                  width: { size: 6860, type: WidthType.DXA },
            ...
            new TableRow({
              children: [
                new TableCell({
                  borders: cellBorders,
                  width: { size: 2500, type: WidthType.DXA },
                  children: [new Paragraph({ children: [new TextRun({ text: "ECOA-BACKEND", bold: true })] })]
                }),
                new TableCell({
                  borders: cellBorders,
                  width: { size: 6860, type: WidthType.DXA },
        ...
        new Paragraph({ numbering: { reference: "setup-list", level: 0 }, children: [new TextRun("Acessem a página de download do portal web (ECOA-WEB) no endereço local do seu computador (ex: http://192.168.0.100:3000/baixar), selecione a aba 'Desenvolvimento' e clique em 'Baixar via Wi-Fi'.")] }),
        ...
        new Paragraph({
          children: [
            new TextRun({ text: "ECOA Mobile & Web — Desenvolvido com foco em escalabilidade de engenharia e beleza de design.", italics: true, color: COLOR_SECONDARY })
          ]
        })
      ]
    }
