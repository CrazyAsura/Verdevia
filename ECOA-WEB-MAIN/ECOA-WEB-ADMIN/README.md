...
>
> Painel operacional do ecossistema ECOA. A interface organiza ocorrências, contratos, evidências, auditoria e dados territoriais para decisões rápidas de zeladoria.
...
| **Admin** | `/administrador` | Gestão de cursos (ECOA Academy), moderação do fórum, triagem de queixas |
...
### Pré-requisitos
- Node.js ≥ 20
- Backend ECOA rodando em `http://localhost:3333`
...
```
/                           → Landing page institucional ECOA
...
- **Plataforma**: Vercel
- **URL de Produção**: `https://ECOA-green.vercel.app`
...
*ECOA Web — Operação territorial, evidência confiável e acompanhamento em tempo real.*
