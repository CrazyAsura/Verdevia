...
export const metadata: Metadata = {
  title: {
    default: "ECOA - Inteligência urbana comunitária",
    template: "%s | ECOA"
  },
  ...
  keywords: ["ECOA", "zeladoria", "inteligência urbana", "reclamação urbana", "cidadania", "segurança", "brasil"],
  ...
  openGraph: {
    type: "website",
    locale: "pt_BR",
    url: "https://ECOA.org.br",
    siteName: "ECOA",
    title: "ECOA - Inteligência urbana comunitária",
    description: "Registre evidências, acompanhe ocorrências locais e transforme relatos comunitários em decisões operacionais.",
    images: [
      {
        url: "https://ECOA.org.br/assets/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "ECOA Plataforma Comunitária",
      }
    ],
  },
  twitter: {
    ...
    images: ["https://ECOA.org.br/assets/og-image.jpg"],
  },
  appleWebApp: {
    capable: true,
...
const schemaData = {
  ...
  "potentialAction": {
    "@type": "SearchAction",
    "target": "https://ECOA.org.br/search?q={search_term_string}",
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                try {
                  var saved = localStorage.getItem('ECOA_theme');
