...
DB_NAME = os.environ.get("DB_NAME", "ECOA_db")
DB_USER = os.environ.get("DB_USERNAME", "ECOA_user")
DB_PASS = os.environ.get("DB_PASSWORD", "ECOA_password")
...
def run_spark_analysis():
    ...
    spark = SparkSession.builder \
        .appName("ECOASparkTelemetryProcessor") \
        .master("local[*]") \
        .getOrCreate()
