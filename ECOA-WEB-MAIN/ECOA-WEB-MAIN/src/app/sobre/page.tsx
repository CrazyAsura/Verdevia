  ...
  return (
    <main className="min-h-screen bg-background mesh-gradient relative pb-20">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <Image
          src="/assets/brazil_amazon_cinematic_1776817751106.png"
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-black italic uppercase tracking-tighter text-glow">ECOA <span className="bg-gradient-to-r from-[#10B981] to-[#3B82F6] bg-clip-text text-transparent font-black">Brasil</span></h1>
        </motion.div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed italic mb-6">
              Fundada em Sergipe e pensada para operar em escala nacional, a ECOA nasceu para encurtar o caminho
