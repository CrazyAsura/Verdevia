              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="supervisor@ECOA.app" {...field} className="bg-black/40 border-white/10 h-14 rounded-xl focus:border-blue-500 transition-all uppercase text-xs" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
