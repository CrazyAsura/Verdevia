                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                               <Input placeholder="superadmin@ECOA.app" {...field} className="bg-black/60 border-[#a855f7]/20 h-14 rounded-none focus:ring-[#a855f7] focus:border-[#a855f7] text-sm text-[#a855f7] font-mono placeholder:text-[#a855f7]/20" />
