# VERDEVIA — Chatbot & AI Backend Subgraph

Este é o microsserviço de backend do domínio de Chatbot do ecossistema VERDEVIA. Ele fornece endpoints GraphQL e REST federados via **Apollo Federation v2** sob a filosofia de **Clean Architecture / Hexagonal Architecture**.
...
*VERDEVIA Chatbot Backend — Engenharia robusta e inteligência distribuída de alta performance.*
