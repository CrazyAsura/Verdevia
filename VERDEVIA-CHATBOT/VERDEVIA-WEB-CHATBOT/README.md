# VERDEVIA — Portal do Assistente Virtual (Chatbot Frontend)

Este é o portal web de visualização do Assistente Virtual da plataforma VERDEVIA, oferecendo uma interface conversacional imersiva em tela cheia (Fullscreen) para triagem e suporte ambiental com RAG.
...
*VERDEVIA Chatbot Front — Conversas fluidas e suporte comunitário instantâneo.*
