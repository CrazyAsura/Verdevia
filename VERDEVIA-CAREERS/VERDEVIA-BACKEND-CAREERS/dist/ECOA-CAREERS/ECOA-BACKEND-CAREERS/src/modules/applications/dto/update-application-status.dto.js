...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Novo status (reviewing, interviewing, accepted, rejected)' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], UpdateApplicationStatusDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Feedback/Observações' }),
    (0, class_validator_1.IsString)(),
