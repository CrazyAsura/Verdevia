    ...
    <section id="servicos" className="py-32 relative">
      <div className="container mx-auto px-6">
        <div className="mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter">A plataforma <span className="bg-gradient-to-r from-[#10B981] to-[#3B82F6] bg-clip-text text-transparent font-black">VERDEVIA</span></h2>
        </div>
