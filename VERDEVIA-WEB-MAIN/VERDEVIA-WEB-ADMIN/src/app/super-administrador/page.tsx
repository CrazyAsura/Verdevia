...
export default function SuperAdminDashboard() {
  const [admins, setAdmins] = useState<AdminUser[]>([
    { id: '1', name: 'Ricardo Santos', email: 'ricardo@VERDEVIA.br', status: 'Ativo', lastLogin: '10 min atrás' },
    { id: '2', name: 'Ana Oliveira', email: 'ana@VERDEVIA.br', status: 'Ativo', lastLogin: '2 horas atrás' },
    { id: '3', name: 'Marcos Lima', email: 'marcos@VERDEVIA.br', status: 'Inativo', lastLogin: '3 dias atrás' },
  ]);
              ...
              <form onSubmit={handleSave} className="space-y-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-primary/50 transition-colors" 
                    placeholder="exemplo@VERDEVIA.br" 
                  />
                </div>
                <div>
