            ...
            subgraphs: [
              {
                name: 'web-backend',
                url:
                  configService.get<string>('WEB_BACKEND_SUBGRAPH_URL') ||
                  'http://localhost:3336/graphql',
              },
              {
              ...
              },
              {
                name: 'admin-backend',
                url:
                  configService.get<string>('ADMIN_BACKEND_SUBGRAPH_URL') ||
                  'http://localhost:3338/graphql',
              },
              {
                name: 'careers-backend',
                url:
                  configService.get<string>('CAREERS_BACKEND_SUBGRAPH_URL') ||
