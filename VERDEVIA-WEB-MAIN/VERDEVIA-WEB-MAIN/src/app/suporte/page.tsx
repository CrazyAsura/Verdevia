      ...
      <div className="mx-auto max-w-5xl space-y-8">
        ...
        <section className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] items-start">
          <div className="space-y-6">
            ...
            <div>
              <h1 className="text-4xl font-black uppercase tracking-tight">Suporte Técnico VERDEVIA</h1>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <InfoCard icon={<Mail size={18} />} title="Contato" text="security@VERDEVIA.br" />
            </div>
          </div>
          ...
          >
            ...
            <div className="space-y-5">
              <div>
                ...
                <Input type="email" required placeholder="admin@VERDEVIA.br" className="bg-white/5 border-white/10 text-white" />
              </div>
              <div>
