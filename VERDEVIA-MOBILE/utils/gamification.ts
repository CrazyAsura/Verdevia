...
export const REWARD_PASS: RewardPassLevel[] = [
  ...
  },
  {
    level: 5,
    xpRequired: 3740,
    free: { label: 'Moldura: Trilha VERDEVIA', kind: 'frame', value: 'frame://trail' },
  ...
  },
  {
    ...
    premium: { label: 'Moldura: Aurora VERDEVIA', kind: 'frame', value: 'frame://aurora' },
  },
  {
    level: 10,
    xpRequired: 12690,
...
export function buildAchievements(source: GamificationSource): Achievement[] {
  ...
  return [
    ...
    make('trusted-eye', 'Olhar Confiavel', 'Tenha 3 denuncias verificadas.', 'Star', verified, 3, 'Moldura: Trilha VERDEVIA'),
