...
export default function SettingsScreen() {
  ...
  const openAppInfo = () => {
    Alert.alert('VERDEVIA', 'Aplicativo VERDEVIA - versao 1.0.5');
  };

  const openVersionInfo = () => {
    Alert.alert('Versao', 'Voce esta usando a versao 1.0.5 do aplicativo VERDEVIA.');
  };
          ...
          <TouchableOpacity onPress={openAppInfo} accessibilityRole="button">
            <Box className={cardClass}>
              <HStack className="items-center justify-between">
                ...
                <Text className={`${secondaryTextClass} text-sm font-bold uppercase`}>VERDEVIA</Text>
              </HStack>
            </Box>
          </TouchableOpacity>
