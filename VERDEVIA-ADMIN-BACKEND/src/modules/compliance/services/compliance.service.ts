  ...
  async onModuleInit() {
    try {
      ...
      if (termsList.length === 0) {
        ...
        oldTerms.content =
          '<h1>Termos e Condições de Uso - VERDEVIA (Antigo)</h1><p>Esta é a primeira versão dos Termos de Uso do aplicativo VERDEVIA.</p>';
        ...
        currentTerms.content = `<h1>Termos e Condições de Uso - VERDEVIA</h1>
<p>Ao utilizar o aplicativo VERDEVIA, o usuário concorda com a fiscalização colaborativa de ocorrências ambientais. O tratamento de dados segue regras estritas de segurança.</p>
...
<p>O usuário declara que as fotos e descrições enviadas são verdadeiras e retratam fatos reais ocorridos no local indicado.</p>`;
      ...
      if (privacyList.length === 0) {
        ...
        privacy.content = `<h1>Política de Privacidade - VERDEVIA</h1>
...
<p>Nenhum dado pessoal identificável é vendido ou compartilhado com terceiros sem consentimento explícito, exceto quando exigido por ordem legal.</p>`;
      ...
      if (cookiesList.length === 0) {
        ...
        cookies.content = `<h1>Diretrizes de Cookies - VERDEVIA</h1>
