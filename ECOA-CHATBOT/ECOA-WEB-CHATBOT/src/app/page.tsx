...
const initialMessages: ChatMessage[] = [
  {
    role: 'assistant',
    content: 'Olá! Sou o assistente virtual da ECOA. Como posso ajudar você hoje com reciclagem, denúncias ou suporte?',
  },
];
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await api.post<{ answer?: string }>('/ai/chat', {
        message: question,
        context: 'Interface cheia imersiva do chatbot ECOA. Responda detalhadamente e em português do Brasil.',
    ...
    <div className="flex h-screen w-screen flex-col bg-zinc-950">
      ...
      <header className="flex items-center justify-between border-b border-white/5 bg-zinc-900/50 p-4 backdrop-blur-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-black uppercase tracking-wider text-white">Assistente ECOA</h1>
