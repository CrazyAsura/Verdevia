...
export default function AdminsManagementPage() {
  ...
  const handleExport = () => {
    ...
    link.href = url;
    link.download = 'administradores-VERDEVIA.csv';
    link.click();
      ...
      <div className="space-y-8">
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
           <div className="flex items-center gap-4">
              ...
              <div>
                 <h2 className="text-2xl font-black uppercase italic tracking-tighter">Administradores <span className="text-primary text-glow">VERDEVIA</span></h2>
