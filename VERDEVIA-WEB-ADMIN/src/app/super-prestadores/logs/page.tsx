...
export default function SubordinateLogsPage() {
  ...
  return (
    <DashboardLayout title="Auditoria de Subordinados" role="super-contractor">
      <div className="space-y-8">
            ...
            <h2 className="text-2xl font-black uppercase tracking-tight flex items-center gap-3">
              {activeTab === 'activities' ? (
                <>
                  ...
                  Logs de <span className="text-primary text-glow">Atividade</span> dos Subordinados
                </>
              ) : (
                <>
                  <AlertOctagon className="text-red-500 text-glow" size={28} />
                  Logs de <span className="text-red-500 text-glow">Erro</span> dos Subordinados
                </>
              )}
            </h2>
            <p className="text-xs text-slate-500 font-bold uppercase tracking-widest mt-1">
              {activeTab === 'activities' 
                ? 'Rastreamento em tempo real de todas as ações de prestadores subordinados na plataforma' 
                : 'Monitoramento em tempo real de todas as exceções e falhas geradas pelos prestadores subordinados'}
            </p>
          </div>
        ...
        <div className="bg-[#080808] border border-white/5 p-4 rounded-2xl flex flex-wrap gap-4 items-center">
          <div className="flex-1 min-w-[200px] relative">
            ...
            <input 
              type="text" 
              placeholder={activeTab === 'activities' ? "BUSCAR POR SUBORDINADO OU AÇÃO..." : "BUSCAR POR ERRO OU ENDPOINT..."}
              ...
              <thead className="bg-white/2 text-[10px] uppercase font-black tracking-widest text-slate-500">
                {activeTab === 'activities' ? (
                  <tr>
                    ...
                    <th className="px-8 py-5 text-left">Subordinado</th>
                      ...
                      <tr key={log.id} className="group hover:bg-white/1 transition-colors">
                        ...
                        <td className="px-8 py-6">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-xs font-black uppercase tracking-tight text-white">{log.userName || 'Subordinado'}</p>
                            ...
                            <td colSpan={7} className="bg-black/50 border-y border-white/5 px-8 py-6">
                              ...
                              >
                                <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-wider text-slate-500">
                                  <span>Rastreamento de Pilha Completo (Stack Trace) do Subordinado</span>
